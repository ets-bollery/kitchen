...
if(theme_is_post_type_edit('portfolio') || theme_is_post_type_new('portfolio')){
	$config['title'] = __('Portfolio Gallery','striking_admin');
}
$options = array(
	array(
...
if(theme_is_post_type_edit('gallery') || theme_is_post_type_new('gallery') || theme_is_post_type_edit('portfolio') || theme_is_post_type_new('portfolio')){
